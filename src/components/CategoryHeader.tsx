...
export function CategoryHeader({ title, count, icon }: CategoryHeaderProps) {
  ...
  return (
    <div className="relative group animate-fadeIn">
      <div className="flex items-center gap-4 p-4 mb-6 rounded-xl bg-white/80 backdrop-blur-sm
        ...
        <div className="flex flex-col sm:flex-row sm:items-baseline gap-2 flex-grow">
          <h2 className="text-xl font-bold bg-gradient-to-r from-gray-700 to-gray-900 
